...
export const TestimonialsSection = () => {
  ...
  <div className="py-16 lg:py-24">
    ...
    <SectionHeader title="Happy People" eyebrow="What People Say about Me" description=" Don't just take my word for it. See what the people I've worked with say about my work." />
    <div className="mt-16 lg:mt-24 flex overflow-x-clip [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
      <div className="flex gap-8 flex-none">
      {testimonials.map((testimonial) =>(
        <Card key={testimonial.name} className="max-w-xs md:p-8 md:max-w-md lg:max-w-lg">
